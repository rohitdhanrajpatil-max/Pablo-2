  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg space-y-10">
      ...
      <div className="space-y-6">
        <div className="group">
          <label htmlFor="hotelName" className="block text-[11px] font-bold text-thv-gold uppercase tracking-widest mb-2 ml-1 transition-colors group-focus-within:text-thv-orange cursor-pointer">Hotel Name</label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-300 group-focus-within:text-thv-orange transition-colors" aria-hidden="true">
              <Building2 size={18} />
            </div>
            <input
              id="hotelName"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="group">
            <label htmlFor="mobile" className="block text-[11px] font-bold text-thv-gold uppercase tracking-widest mb-2 ml-1 transition-colors group-focus-within:text-thv-orange cursor-pointer">Your Mobile</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-300 group-focus-within:text-thv-orange transition-colors" aria-hidden="true">
                <Smartphone size={18} />
              </div>
          ...
          <div className="group">
            <label htmlFor="nightsStay" className="block text-[11px] font-bold text-thv-gold uppercase tracking-widest mb-2 ml-1 transition-colors group-focus-within:text-thv-orange cursor-pointer">Nights</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-300 group-focus-within:text-thv-orange transition-colors" aria-hidden="true">
